    ...
    assertions = [
      {
        ...
        assertion =
          ...
          let
            ...
            apps = filter (app: app.name != "test2") (attrsToList expr);
          in
          all (
            app:
            app.value.spec.destination.server == defaultServer
      ...
      }
      {
        ...
        assertion =
          spec:
          spec.destination.server == "https://kubernetes.default.svc:6443"
