                ...
                propName: property: let
                  ...
                  optionProperties =
                    ...
                    then
                      ...
                      else if hasTypeMapping schema.definitions.${refDefinition property}
                      then {
                    ...
                    then
                      ...
                      then
                        ...
                        if hasTypeMapping schema.definitions.${refDefinition property.items}
                        then {
                          type = requiredOrNot (types.listOf (mapType schema.definitions.${refDefinition property.items}.type));
                        }
                    ...
                    then
                      ...
                      then {
                        type = requiredOrNot (types.attrsOf (mapType schema.definitions.${refDefinition property.additionalProperties}));
                      }
